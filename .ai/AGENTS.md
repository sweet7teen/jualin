...
# Package Management & Code Generation
...
When adding dependencies, always use:
...
Always prefer official CLI tools and generators instead of manually creating boilerplate.
...
- Official code generators whenever available.

Do not manually recreate components, configurations, or project structures that can be generated by official tooling.

Always follow the official documentation and recommended installation process for every library or framework.

Avoid custom implementations when an official solution exists.
